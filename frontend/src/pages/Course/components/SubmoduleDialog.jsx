...
const SubmoduleDialog = ({ open, onClose, onSave, submoduleData, moduleId, isSaving }) => {
  const isEditMode = !!submoduleData;
    ...
    if (open) {
      if (isEditMode && submoduleData) {
        reset({
          ...
          level: submoduleData.level || 'Beginner',
          language: submoduleData.language || 'English',
          estimatedDuration: submoduleData.estimatedDuration || '',
          brandColor: submoduleData.brandColor || '#6C1D5F',
          bannerImage: submoduleData.bannerImage || '',
  ...
  }, [open, isEditMode, submoduleData, reset]);
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <DialogTitle fontWeight={700}>
          {isEditMode ? 'Edit Submodule' : 'Add Submodule'}
        </DialogTitle>
...
export default SubmoduleDialog;
