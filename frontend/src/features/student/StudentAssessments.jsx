...
function AssessmentDetail({ assessment, submission, questions, user, store, onBack, showToast }) {
  ...
  function submit(payload) { store.submitWork({ ...payload, assessmentId: assessment.id, studentId: user.studentId || user.id, studentName: user.name }); }
